...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: 'Sahjony Capital LLC - Real Estate Wholesale Platform',
      },
      {
        name: 'description',
        content:
          'Sahjony Capital LLC - AI-Powered Real Estate Wholesale Platform with multi-agent AI architecture for property acquisition, disposition, and portfolio management.',
      },
      {
        property: 'og:image',
        content: '/cover.png',
