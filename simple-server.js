...
const server = http.createServer((req, res) => {
  ...
  if (req.url === '/' || req.url === '/index.html') {
    // Check if we have a built SSR application
        ...
        <html>
          ...
          <body>
            <div id="root">
              ...
              <p>Status: Hermes Workspace is running on port ${PORT}</p>
              <p>Next Steps: Build full SSR application for production use</p>
            </div>
          </body>
        </html>
      `);
